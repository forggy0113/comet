...
function stepFail(message: string): void {
  red(`  [FAIL] ${message}`);
  stepsTotal += 1;
}
function stepDry(message: string): void {
...
function annotateFrontmatter(file: string, extraFields: string): void {
